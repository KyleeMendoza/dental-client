  ...
  const serviceList = [
    {
      ...
      description:
        "Our skilled dental professionals are committed to providing compassionate care throughout the tooth extraction process. Whether addressing problematic wisdom teeth, severely damaged teeth, or part of a comprehensive treatment plan, we prioritize your comfort and well-being. Utilizing the latest techniques, we ensure a gentle and precise extraction experience. We take the time to discuss your case thoroughly, addressing any concerns and providing clear post-extraction care instructions for optimal healing. Trust Smiles Dental for expert tooth extractions that prioritize your comfort and contribute to your ongoing oral health journey.",
      price: "₱500",
      caption:
        "Experience compassionate and expert tooth extractions at Smiles Dental, where precision meets comfort. Trust our skilled professionals to prioritize your well-being, making the process gentle and worry-free.",
    },
    {
        ...
        <div className="flex w-full items-center justify-center relative">
          ...
          <div className="py-10 w-[85%] flex flex-col gap-5 text-center font-['Poppins'] z-20">
            ...
            <p className="text-lg text-white">
              Step into a world of exceptional dental care at Smiles Dental. Our
              array of services is designed to cater to your unique oral health
              needs, ensuring a lifetime of confident and healthy smiles. From
              routine check-ups and preventive care to cutting-edge cosmetic and
              restorative treatments, we provide a holistic approach to dental
              well-being. Experience the precision of our state-of-the-art
              technology coupled with the expertise of our skilled
              professionals. Whether you're looking to enhance your smile,
              address dental concerns, or maintain optimal oral health, our
              diverse range of services is tailored to meet your individual
              requirements. Explore the possibilities with Smiles Dental — your
              trusted partner on the journey to a brighter, healthier smile!
            </p>
          </div>
        </div>
